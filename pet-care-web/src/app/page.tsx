      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <p className="mt-auto max-w-[60ch] text-[clamp(1.1rem,2vw,1.5rem)] font-light leading-relaxed text-slate-600 px-4">
            Elevando el estándar del bienestar animal. Un santuario de cuidado donde la
        ...
        <div className="flex flex-col h-full justify-between">
          <div className="flex justify-between items-start">
            <p className="text-xs font-bold uppercase tracking-[0.3em] text-indigo-300 flex items-center gap-2">
              <Heart size={14} /> Servicios Curados
            </p>
          ...
          <div className="relative">
            <h2 className="text-[clamp(3.5rem,12vw,14rem)] font-serif italic leading-[0.8] uppercase tracking-tighter">
              Cuidado
              <br />
              <span className="text-indigo-400">A Medida</span>
            </h2>
          </div>
            ...
            {[
              {
                ...
                desc: "Suites privadas con control climático y atención personalizada 24/7 para una estancia sin estrés."
              },
              {
                icon: <PawPrint className="text-indigo-400" />,
                title: "Paseos de Élite",
                desc: "Rutas seleccionadas y estimulación cognitiva para mantener la vitalidad y el equilibrio de su mascota."
              },
              {
                icon: <ShieldCheck className="text-indigo-400" />,
                title: "Clínica de Bienestar",
                desc: "Monitoreo preventivo la vanguardia médica para asegurar una vida plena y saludable."
              }
            ].map((item, idx) => (
      ...
      >
        <div className="flex flex-col h-full justify-between">
          <p className="text-xs font-bold uppercase tracking-[0.3em] text-indigo-500 flex items-center gap-2">
            <Star size={14} /> Nuestra Filosofía
          </p>
          ...
          <div className="relative">
            <h2 className="text-[clamp(3.5rem,12vw,14rem)] font-serif italic leading-[0.8] uppercase tracking-tighter">
              Confianza
              <br />
              <span className="text-indigo-600">Absoluta</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { step: "01", title: "Curaduría", desc: "Análisis detallado de la personalidad y necesidades específicas de su mascota." },
              { step: "02", title: "Sincronía", desc: "Asignación de un cuidador experto especializado en su raza y temperamento." },
              { step: "03", title: "Armonía", desc: "Integración total en nuestra rutina de bienestar, lujo y serenidad." }
            ].map((step, idx) => (
            ...
            <div className="flex -space-x-3">
              {[1,2,3,4].map(i => (
                <div key={i} className="w-10 h-10 rounded-full border-2 border-white bg-slate-300 overflow-hidden">
                   <img src={`https://i.pravatar.cc/150?u=${i}`} alt="cliente" />
                </div>
              ))}
            </div>
      ...
      >
        <div className="flex flex-col items-center text-center">
          <p className="text-xs font-bold uppercase tracking-[0.4em] text-indigo-500 mb-4 flex items-center gap-2">
            <PawPrint size={14} /> La Invitación
          </p>
          ...
          <div className="relative">
            <h2 className="text-[clamp(3.5rem,12vw,14rem)] font-serif italic leading-[0.8] uppercase tracking-tighter">
              Únase a la
              <br />
              <span className="text-indigo-600">Élite</span>
            </h2>
          </div>
          ...
          <p className="mt-auto max-w-[50ch] text-[clamp(1rem,2vw,1.5rem)] font-light leading-relaxed text-slate-600 px-4">
            ...
            Cupos limitados para garantizar el estándar más alto de calidad.
          </p>
